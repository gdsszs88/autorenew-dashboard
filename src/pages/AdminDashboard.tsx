            ...
            <div className="bg-card p-6 rounded-2xl shadow-sm border border-border">
              ...
              <div className="bg-muted/50 p-4 rounded-xl border border-border mt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-muted-foreground mb-1">默认开通入站 ID</label>
                    <input
                      ...
                      className="w-full border border-border bg-background text-foreground p-2 rounded-lg focus:ring-2 focus:ring-primary outline-none text-sm"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-muted-foreground mb-1">默认协议类型</label>
                    <select
